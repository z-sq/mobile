        ...
        <table className="w-full">
          <tbody>
            ...
            <tr>
              ...
              <BasicFormItem label="评标方式" text={data.judMetName || ''} />
            </tr>
            <tr>
              <BasicFormItem label="标书费金额" text={data.bidFeeAmt || ''} />
              <BasicFormItem label="保证金金额" text={data.bondAmt || ''} />
            </tr>
            <tr>
