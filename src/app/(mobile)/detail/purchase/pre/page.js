        ...
        <table className="w-full">
          <tbody>
            ...
            <tr>
              ...
              <BasicFormItem label="合同估算价" text={data.estConAmt || ''} />
            </tr>
            <tr>
              {/* <BasicFormItem label="履约地点" text={data.perPlace || ''} /> */}
              <BasicFormItem
                label="资格预审方法"
                text={data.preMetName || ''}
              />
              <BasicFormItem label="合格分数" text={data.pasScore || ''} />
            </tr>
            {/* <tr>
            ...
            <tr>
              <BasicFormItem label="数量基准" text={data.quaBasis || ''} />
              <BasicFormItem label="数量限制" text={data.quaLim || ''} />
            </tr>
            <tr>
              <BasicFormItem
                label="资格预审文件金额"
            ...
            <tr>
              ...
              <BasicFormItem
                label="递交截止时间"
                text={`${data.preEndDate || ''} ${data.preEndTime || ''}` || ''}
              />
            </tr>
            <tr>
              <BasicFormItem
